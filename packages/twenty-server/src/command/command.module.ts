...
import { FieldPermissionsCommandsModule } from 'src/engine/metadata-modules/object-permission/commands/field-permissions-commands.module';
...
@Module({
  imports: [
    ...
    FieldMetadataModule,
    FieldPermissionsCommandsModule,
  ],
})
